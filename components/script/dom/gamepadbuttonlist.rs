...
impl GamepadButtonList {
    ...
    pub fn new_from_vr(global: &GlobalScope, buttons: &Vec<webvr::VRGamepadButton>) -> Root<GamepadButtonList> {
    ...
    pub fn sync_vr(&self, vr_buttons: &Vec<webvr::VRGamepadButton>) {
        let mut index = 0;
